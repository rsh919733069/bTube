...
#### 任务清单
- [x] 6.1 主页框架
  - [x] `main/MainNav.kt` - 主页容器、底部导航
  - [x] `main/HomeViewModel.kt`
  - [x] 底部导航栏（首页、动态、我的、设置）
  
- [x] 6.2 推荐页
  - [x] `main/home/recommend/RecommendScreen.kt`
  - [x] 视频卡片组件（VerticalVideoCard）
  - [x] 下拉刷新、分页加载
  
- [x] 6.3 热门页
  - [x] `main/home/hot/HotScreen.kt`
  - [x] 热门视频列表
  - [x] 下拉刷新
...
- [ ] 6.5 订阅页
  - [x] `main/subscription/SubscriptionScreen.kt`（占位）
  - [ ] `main/subscription/SubscriptionViewModel.kt`
  - [ ] 动态卡片组件
  
- [ ] 6.6 个人资料页
  - [x] `main/profile/ProfileScreen.kt`（占位）
...
### 下一步计划
**阶段 6 收尾** - 番剧页、完善订阅/个人资料  
**阶段 7** - 视频播放器

### 最近更新
- 2026-02-04: 阶段6 推荐/热门页、下拉刷新、视频跳转、播放占位
- 2026-02-04: MediaPlayConfig、VideoPlayPlaceholder
